...
import database_alunos as database #Ficheiro com as querys sql
from tkinter import messagebox #Interface
from tkinter import simpledialog #Interface
import logic_alunos as logic #Ficheiro com a lógica do programa
...
def gestao_alunos(main_frame):
    ...
    icon_person.image = icon_person_tk
    ...
    info_person_courses = Listbox(info_person, font='Arial 14', width=30, borderwidth=0, bg='#F0F0F0') #Lista com os cursos do aluno
    ...
    button2 = Button(menu_alunos, text='Alterar dados de Aluno', **button_styles_mini_menu, command=lambda:update_info_user(main_frame)) #Botão do menu para aceder às outras páginas
    button2.pack(pady=10, padx=10, fill='x')

    button3 = Button(menu_alunos, text='Adicionar Aluno a Curso', **button_styles_mini_menu, command=lambda:add_course(main_frame)) #Botão do menu para aceder às outras páginas
    button3.pack(pady=10, padx=10, fill='x')

    button4 = Button(menu_alunos, text='Remover Aluno de um Curso', **button_styles_mini_menu, command=lambda:remove_course(main_frame)) #Botão do menu para aceder às outras páginas
    ...
    title_page.place(x=300, y=5)



def update_info_user(main_frame):#-----------------------------Página de atualizar dados do aluno---------------------------------
    ...
    button1 = Button(menu_alunos, text='Informação Pessoal', **button_styles_mini_menu, command=lambda: gestao_alunos(main_frame))  # Botão do menu para aceder às outras páginas
    button1.pack(pady=10, padx=10, fill='x')

    button2 = Button(menu_alunos, text='Alterar dados de Aluno', **button_styles_mini_menu)  # Botão do menu para aceder às outras páginas
    button2.pack(pady=10, padx=10, fill='x')
...
def add_course(main_frame):#-----------------------------Adicionar aluno a um curso-------------------------
    logic.clear_content_frame(main_frame)
    alunos = database.alunos()
    ...
    button3 = Button(menu_alunos, text='Adicionar Aluno a Curso', **button_styles_mini_menu)  # Botão do menu para aceder às outras páginas
    button3.pack(pady=10, padx=10, fill='x')
...
def remove_course(main_frame):
    ...
    button4 = Button(menu_alunos, text='Remover Aluno de um Curso', **button_styles_mini_menu)  # Botão do menu para aceder às outras páginas
    button4.pack(pady=10, padx=10, fill='x')
